...
<div class="container" style="margin-top: 1%">
    <div class="row" style="height: 70px">
        <div class="col-md-3" >
                <input class="form-control" id="id_txt_filtro"  name="filtro" placeholder="Ingrese el  n�mero del aula" type="text" maxlength="30"/>
        </div>
        <div class="col-md-2" >
                            ...
                            <div id="stepOne" class="panel-collapse collapse in">
                                <div class="panel-body">
                                     <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
											<input class="form-control" id="id_reg_numero" name="numero" placeholder="Ingrese el N�mero de la Sala" type="text" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label" for="id_reg_piso">Piso</label>
                                        <div class="col-lg-6">
											<input class="form-control" id="id_reg_piso" name="piso" placeholder="Ingrese el N�mero del Piso de la Sala" type="number"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label" for="id_reg_numAlumnos">N&uacutemero de Alumnos</label>
                                        <div class="col-lg-6">
											<input class="form-control" id="id_reg_numAlumnos" name="numAlumnos" placeholder="Ingrese el N�mero de alumnos" type="number" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                             ...
                             <div class="panel-body">
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                     ...
                                     <div class="col-lg-6">
                                         <input class="form-control" id="id_act_numero" name="numero" placeholder="Ingrese el N�mero de la Sala" type="text" />
                                     </div>
                                 </div>
                                 <div class="form-group">
                                     <label class="col-lg-3 control-label" for="id_act_piso">Piso</label>
                                     <div class="col-lg-6">
                                         <input class="form-control" id="id_act_piso" name="piso" placeholder="Ingrese el N�mero del Piso de la Sala" type="number" />
                                     </div>
                                 </div>
                                 <div class="form-group">
                                     <label class="col-lg-3 control-label" for="id_act_numAlumnos">N&uacutemero de Alumnos</label>
                                     <div class="col-lg-6">
                                         <input class="form-control" id="id_act_numAlumnos" name="numAlumnos" placeholder="Ingrese el N�mero de Alumnos" type="number" />
                                     </div>
                                 </div>
                                 <div class="form-group">
...
$('#id_form_registra').bootstrapValidator({
    ...
    fields: {
    	"numero": {
            ...
            validators: {
                notEmpty: {
                    message: 'El N�mero de la sala es un campo obligatorio'
                },
                regexp:{
    				  regexp: /^[A-Z][0-9]{3}$/,
    				  message:'el N�mero de la sala  debe contener un caracter en mayuscula y 3 d�gitos'
    			  }
        ...
        "piso": {
            ...
            validators: {
                ...
                regexp:{
  				  regexp: /^[0-9]{1,2}$/,
  				  message:'el  campo Piso debe contener de 1 a 2 d�gitos'
  			  },
            }
        },
        "numAlumnos": {
            ...
            validators: {
            	notEmpty: {
                    message: 'El campo N�mero de Alumnos es un campo obligatorio'
                },
                regexp:{
    				  regexp: /^[0-9]{1,2}$/,
    				  message:'El campo N�mero de Alumnos  debe contener de 1 a 2 d�gitos'
    			  },
            }
        },
        "recursos": {
...
$('#id_form_actualiza').bootstrapValidator({
    ...
    fields: {
    	"numero": {
            ...
            validators: {
                notEmpty: {
                    message: 'El campo N�mero es un campo obligatorio'
                },
                regexp:{
  				  regexp: /^[A-Z][0-9]{3}$/,
  				  message:'El campo N�mero  debe contener un caracter en mayuscula y 3 d�gitos'
  			  },
  			remote :{
            	...
            	message : 'El N�mero de Sala ya existe o ya a sido registrado',
